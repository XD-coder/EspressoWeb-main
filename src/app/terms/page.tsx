      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-[300px,1fr] gap-8">
          ...
          >
            ...
            <div id="acceptance" className="bg-dark-200 rounded-lg p-8 mb-8 border border-dark-300 scroll-mt-24">
            ...
            <div id="fair-usage" className="bg-dark-200 rounded-lg p-8 border border-dark-300 scroll-mt-24">
              ...
              <p className="text-neutral-400 mb-4">
                Examples of prohibited activities under this policy include, but are not limited to: running crypto miners, file-sharing services that consume excessive bandwidth, or any automated process that places undue strain on shared resources.
              </p>
              <p className="text-neutral-400">
                We reserve the right to determine what constitutes a violation of this Fair Usage Policy. If you anticipate high resource needs, please contact us to discuss appropriate solutions.
              </p>
            </div>
          </motion.div>
        </div>
